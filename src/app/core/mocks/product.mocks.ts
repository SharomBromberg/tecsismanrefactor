...
const defaultComments: ProductComment[] = [
  {
    ...
    text: 'Excelente producto, superó mis expectativas.',
  ...
  {
    author: 'Ana Silva',
    text: 'Muy buena relación calidad-precio. Recomendado.',
    message: 'Muy buena relación calidad-precio. Recomendado.',
    rating: 4,
...
export const MOCK_PRODUCTS: Product[] = [
  // --- CATEGORÍA 1: Cloud Computing ---
  {
    ...
    description:
      'Instancia virtual de alto rendimiento ideal para aplicaciones críticas.',
  ...
  },
  {
    ...
    description:
      'Alojamiento para webs de alto tráfico con panel de control incluido.',
    technicalDescription:
      'Ancho de banda ilimitado, cPanel, Certificado SSL gratis.',
    price: 15.0,
    stock: 500,
    categoryId: 'c1',
    images: [
  ...
  },
  {
    ...
    description:
      'Almacenamiento seguro y redundante para respaldos corporativos.',
    technicalDescription:
      '1TB de espacio, Encriptación AES-256 en reposo, 99.9% uptime.',
    price: 8.5,
    stock: 200,
    categoryId: 'c1',
    images: [
  ...
  },
  {
    ...
    technicalDescription:
      'Gestión DNS avanzada incluida, Protección WHOIS opcional.',
    price: 12.0,
    stock: 999,
    categoryId: 'c1',
    images: [
  ...
  // --- CATEGORÍA 2: Seguridad Informática ---
  {
    ...
    technicalDescription:
      'Throughput 5 Gbps, Filtrado Web, Control de aplicaciones.',
    price: 850.0,
    stock: 15,
    categoryId: 'c2',
    images: [
  ...
  },
  {
    ...
    technicalDescription:
      'Lente varifocal motorizado, visión nocturna 30m, PoE.',
    price: 120.0,
    stock: 45,
    categoryId: 'c2',
    images: [
  ...
  },
  {
    ...
    technicalDescription:
      'Conexión TCP/IP, capacidad para 3000 usuarios, salida de relé.',
    price: 340.0,
    stock: 10,
    categoryId: 'c2',
    images: [
  ...
  },
  {
    ...
    technicalDescription:
      'Análisis de caja negra y blanca, reporte de vulnerabilidades OWASP.',
    price: 1500.0,
    stock: 5,
    categoryId: 'c2',
    images: [
  ...
  },
  {
    ...
    technicalDescription:
      'Certificación IP67, soporte PoE, Antenas Direccionales.',
    price: 210.0,
    stock: 18,
    categoryId: 'c3',
    images: [
  ...
  },
  {
    ...
    description:
      'Gabinete cerrado para servidores y equipos de telecomunicaciones.',
    technicalDescription:
      'Acero SPCC, Puerta frontal de vidrio templado, Ruedas integradas.',
    price: 650.0,
    stock: 4,
    categoryId: 'c3',
    images: [
  ...
  // --- CATEGORÍA 4: Periféricos y Accesorios ---
  {
    ...
    description:
      'Monitor curvo ideal para programación y productividad extrema.',
  ...
  },
  {
    ...
    technicalDescription:
      'Switches Brown, Conexión Bluetooth/2.4Ghz, Batería 4000mAh.',
    price: 135.0,
    stock: 35,
    categoryId: 'c4',
    images: [
  ...
  },
  {
    ...
    description:
      'Auriculares de diadema perfectos para oficina y videollamadas.',
  ...
  },
  {
    ...
    technicalDescription:
      'Sensor Sony 4K, Autoenfoque, Micrófonos duales estéreo.',
    price: 180.0,
    stock: 22,
    categoryId: 'c4',
    images: [
